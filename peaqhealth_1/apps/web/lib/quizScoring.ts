...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    subtext: "Chronic exhaustion despite adequate sleep duration is one of the patterns population research associates with disrupted nighttime breathing. The oral microbiome carries signatures of altered breathing that Oravi tracks.",
    options: [
...
function buildInsights(tags: string[]): Pick<QuizResult, "primaryInsight" | "secondaryInsight" | "tertiaryInsight"> {
  ...
  if (isFemale && hasPregnant && hasPerio) {
    ...
    primaryInsight = "Pregnancy changes your oral microbiome in ways that matter beyond your mouth. Hormonal shifts increase gingival inflammation and create conditions that favor periodontal pathogens. Women with periodontitis face 5.56\u00d7 higher preeclampsia risk. Oravi would measure your periodontal pathogen load alongside your inflammatory markers to give you a complete picture."
  ...
  if (hasNitrate || tags.includes("mouthwash")) {
    secondaryInsight = "Oravi measures your nitrate-reducing bacteria specifically \u2014 Neisseria, Rothia, and Veillonella \u2014 and connects their abundance to your HRV and blood pressure data. This is a signal no standard dental exam or blood panel has ever shown you."
  } else if (hasAirway) {
    secondaryInsight = "Oravi tracks OSA-associated taxa \u2014 Prevotella and Fusobacterium \u2014 and cross-references them with your sleep wearable data. If your oral microbiome is flagging airway risk and your HRV confirms it, that\u2019s a cross-panel signal no single test could generate."
  } else {
    secondaryInsight = "Oravi sequences your oral microbiome at species level \u2014 not just diversity, but which specific bacteria are present and at what levels \u2014 and connects that data to your blood markers and nightly sleep physiology."
  }

  const tertiaryInsight = "What you\u2019ve never seen is how all of this connects in one picture. Your oral microbiome, your hs-CRP, your HRV \u2014 they\u2019re part of the same system. Oravi is the first platform that shows you all three together."
