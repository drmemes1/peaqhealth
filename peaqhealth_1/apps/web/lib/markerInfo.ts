...
López-Otín C et al. Cell. 2023;186(2):243–278 (hallmarks of aging, includes dysbiosis and inflammaging).`,
  ...
  "nitrate-reducing": {
    why: "Neisseria, Rothia, and Veillonella convert dietary nitrate into nitric oxide (NO), the primary vasodilator your blood vessels use to regulate blood pressure. Mouthwashes containing alcohol, chlorhexidine, or essential oils (thymol, eucalyptol, menthol) kill these bacteria, acutely impairing the NO pathway. Dry mouth (from stress, medications, mouth breathing, or aging) also depletes these bacteria by reducing the salivary flow they depend on. Emotional stress increases sympathetic tone, reducing parasympathetically-driven salivary secretion, creating a direct HRV \u2192 salivary flow \u2192 nitrate-reducer depletion pathway.",
    target: "\u22655% of reads",
    citation: "Kapil V et al., Hypertension 2015, n=300; Petersson J et al., Free Radical Biology & Medicine 2009",
    tip: "Switch to a fluoride-only mouthwash or stop using mouthwash entirely. Green leafy vegetables (spinach, arugula, beetroot, celery) directly feed nitrate-reducing bacteria. Stress management and adequate hydration also protect salivary flow.",
  },
