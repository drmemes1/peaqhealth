...
const SECTIONS: {
  ...
  },
  {
    ...
    color: "#185FA5",
    keys: ["sleepDuration", "sleepLatency", "nightWakings", "daytimeFatigue", "nonRestorativeSleep", "nasalObstruction", "sinusHistory", "snoringReported", "osaWitnessed", "nocturnalArousal", "mouthBreathing", "mouthBreathingConfirm", "bruxismNight", "gerd", "caffeineCutoff"],
  },
  {
...
const QUESTIONS: QuestionDef[] = [
  ...
  // ── Airway & Sleep Context (Ticket 1 + new questions) ──────────────────────
  {
    key: "mouthBreathingConfirm", dbKey: "mouth_breathing_confirm",
    label: "Do you often wake up with a dry mouth or chapped lips?",
    context: "Dry mouth on waking is one of the most reliable signs of nocturnal mouth breathing.",
    type: "choice",
    options: [
      { value: "never",     label: "Never" },
      { value: "sometimes", label: "Sometimes" },
      { value: "often",     label: "Often" },
      { value: "always",    label: "Almost every morning" },
    ],
  },
  {
    key: "bruxismNight", dbKey: "bruxism_night",
    label: "Do you wake up with jaw pain, sore teeth, or a headache?",
    context: "Night-time bruxism is associated with sleep-disordered breathing and stress-related arousals.",
    type: "choice",
    options: [
      { value: "never",     label: "Never" },
      { value: "sometimes", label: "Sometimes" },
      { value: "often",     label: "Often" },
      { value: "diagnosed", label: "Yes — I have a diagnosis or wear a night guard" },
    ],
  },
  {
    key: "nonRestorativeSleep", dbKey: "non_restorative_sleep",
    label: "Even after a full night's sleep, do you still feel unrefreshed?",
    context: "Non-restorative sleep is a hallmark of sleep fragmentation, even when total duration looks adequate.",
    type: "choice",
    options: [
      { value: "never",     label: "Never" },
      { value: "sometimes", label: "Sometimes" },
  ...
  {
    key: "osaWitnessed", dbKey: "osa_witnessed",
    label: "Has anyone told you that you stop breathing or gasp during sleep?",
    context: "Witnessed apneas are highly specific for obstructive sleep apnea.",
    type: "choice",
    options: [
      { value: "no",       label: "No" },
      { value: "possibly", label: "I'm not sure — I sleep alone" },
      { value: "yes",      label: "Yes" },
    ],
  },
  {
    key: "nocturnalArousal", dbKey: "nocturnal_arousal",
    label: "Do you ever wake up suddenly feeling like you're gasping or with your heart racing?",
    context: "Sudden awakenings with choking or pounding heart can indicate nocturnal arousals from airway obstruction.",
    type: "choice",
    options: [
      { value: "never",     label: "Never" },
      { value: "rarely",    label: "Rarely" },
  ...
  {
    key: "gerd", dbKey: "gerd",
    label: "Do you ever experience acid reflux or heartburn?",
    context: "Acid reflux and sleep quality are closely connected.",
    type: "choice",
    options: [
      { value: "never",        label: "Never" },
      { value: "occasionally", label: "Occasionally" },
      { value: "often",        label: "Often" },
      { value: "diagnosed",    label: "Yes — I have a diagnosis" },
    ],
  },
  {
    key: "caffeineCutoff", dbKey: "caffeine_cutoff",
    label: "When do you typically have your last caffeine of the day?",
    context: "Caffeine has a half-life of 5–7 hours and can affect sleep quality even when you don't feel it.",
    type: "choice",
    options: [
      ...
      { value: "late_afternoon",   label: "Late afternoon (2–5pm)" },
