    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontFamily: serif, fontSize: 52, fontWeight: 300, color: "#141410", lineHeight: 1, marginBottom: 8 }}>
    ...
    <>
      <div style={{
        ...
        <div className="method-cols" style={{
          ...
          {[
            { ord: "01", title: "The study", body: "CDC NHANES 2009\u20132012 sequenced the mouth bacteria of 9,660 Americans using 16S rRNA sequencing. Largest nationally representative oral microbiome study in the US." },
            { ord: "02", title: "Our analysis", body: "We linked oral microbiome data to blood marker files for 9,848 participants. We tested correlations between pre-specified bacteria and blood markers across inflammation, lipids, glucose, and blood pressure." },
            { ord: "03", title: "Honest framing", body: "These are population associations, not individual predictions. Effect sizes are small (r=0.03\u20130.09). Your Zymo kit uses a swab; NHANES used oral rinse. Both use the same sequencing technology. Comparisons are directionally accurate." },
          ].map(c => (
      ...
      <div style={{ textAlign: "center", padding: "48px 0 88px" }}>
        <p style={{
