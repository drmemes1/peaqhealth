    ...
    <>
      ...
      <main style={{ maxWidth: 680, margin: "0 auto", padding: "64px 24px 120px" }}>
        ...
        {[
          ...
          { id: "I3", title: "Dual inflammatory", penalty: "up to 2 pts", trigger: "hsCRP >1.0 mg/L AND ESR elevated", cite: null, desc: "When both are running above typical, it tends to reflect inflammatory signals showing up across more than one system." },
