...
const citations = [
  {
    ...
    peaqMeaning: "This is why Peaq connects your P. gingivalis level to your hsCRP score. The pathway is confirmed at the highest institutional level of evidence.",
  ...
  },
  {
    ...
    peaqMeaning: "This study \u2014 co-authored by Paul Ridker, the cardiologist who defined residual inflammatory risk \u2014 directly validates the weight Peaq assigns to your hsCRP score relative to your LDL-C.",
  ...
  },
  {
    ...
    quote: "P. gingivalis detected in Alzheimer\u2019s disease brains.",
    tag: "Oral \u2192 Brain",
    tagColor: "#6B4C8A",
    panelBorderColor: "#6B4C8A",
    expandedFinding: "P. gingivalis \u2014 the keystone periodontal pathogen \u2014 and its toxic proteases (gingipains) were identified in brain tissue from Alzheimer\u2019s patients. Gingipain inhibition reduced neuroinflammation in mouse models.",
    effectSize: "P. gingivalis DNA detected in 96% of AD brain samples vs controls. Gingipain levels correlated with tau and ubiquitin pathology.",
    peaqMeaning: "Your P. gingivalis percentage in Peaq isn\u2019t just a periodontal metric. It\u2019s connected to neuroinflammation research that may link oral dysbiosis to cognitive decline.",
    evidenceType: "Mechanistic + human tissue study",
    affectedPanels: ["oral"],
  },
] as const
