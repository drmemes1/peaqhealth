// LEGACY: Used only for users without a V5 snapshot.
// Remove after V5 migration is confirmed complete (all
// users have score_version = 'v5' in score_snapshots).
"use client"
    ...
    if (sleepData &&
      ...
      computed.push({
        ...
        learnMore: {
          ...
          citation: "Portelli et al., Dentistry Journal 2024 (meta-analysis, n=88,040). Mi et al., BMC Oral Health 2023 (Mendelian randomization).",
        },
      })
    }
          ...
          <>
            ...
            <div style={{ width: "100%", aspectRatio: "680 / 420" }}>
              <svg viewBox="0 0 680 420" preserveAspectRatio="xMidYMid meet" style={{ width: "100%", height: "100%", display: "block" }}>
                ...
                <path d="M0 310 L60 280 L140 296 L210 260 L290 282 L375 245 L450 265 L525 250 L590 268 L650 255 L680 262 L680 310 Z" fill="url(#pviz-mtn2)" />
