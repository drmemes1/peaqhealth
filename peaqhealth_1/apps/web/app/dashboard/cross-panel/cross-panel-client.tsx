      ...
      <main style={{ maxWidth: 680, margin: "0 auto", padding: "32px 24px 80px" }}>
        ...
        <div style={{
          ...
          <p style={{ fontFamily: "var(--font-body)", fontSize: 14, color: "var(--ink-60)", lineHeight: 1.7, margin: "0 0 16px" }}>
            Without cross-panel modifiers your base score would be {baseScore}. The {modifierTotal >= 0 ? "+" : ""}{modifierTotal} net effect brings your Oravi Age to {score}. {modifiers.find(m => m.id === "triple_cardio_risk") ? "Improving the Triple cardiovascular signal alone would recover up to 5 points." : ""}
          </p>
