      ...
      <main style={{ maxWidth: 680, margin: "0 auto", padding: "32px 24px 80px" }}>
        ...
        {oralScore?.watchSignals && (
          (() => {
            ...
            const signals = [
              { key: "alzheimersRisk", label: "Alzheimer's-associated taxa", val: ws.alzheimersRisk },
              { key: "colorectalSignal", label: "Colorectal cancer-linked bacteria", val: ws.colorectalSignal },
              { key: "diabetesSignal", label: "Diabetes-associated dysbiosis", val: ws.diabetesSignal },
              { key: "raSignal", label: "Rheumatoid arthritis signal", val: ws.raSignal },
            ].filter(s => s.val > 0)
        ...
        {rawOtu && (
          <>
            ...
            <Section title="Periodontal Pathogens" defaultOpen={true}>
              ...
              <SpeciesRow name="Prevotella intermedia" role="Hormone-responsive periodontopathogen" val={sp("Prevotella intermedia")} target="<0.5% reads" isPathogen={true} note="Uses progesterone and estrogen as growth factors — elevated in pregnancy gingivitis" flagFn={v => flag(v < 0.5, v < 1.5)} learnWhat="A gram-negative anaerobe that can substitute sex hormones (progesterone, estradiol) for vitamin K as growth factors, making it highly active during hormonal fluctuations." learnWhy="Elevated during pregnancy, puberty, and oral contraceptive use. Associated with systemic inflammation and adverse pregnancy outcomes including preterm birth." learnCitation="Kornman & Loesche, Journal of Periodontal Research, 1980. Hormonal effects on oral microbiome." />
              <SpeciesRow name="Fusobacterium nucleatum" role="Colorectal cancer link — systemic infection bridge" val={sp("Fusobacterium nucleatum")} target="<0.5% reads" isPathogen={true} note="Kostic et al., Nature 2012: enriched in colorectal adenocarcinoma tissue vs. healthy colon" flagFn={v => flag(v < 0.5, v < 1.5)} learnWhat="An opportunistic pathogen that bridges the oral cavity to other body sites. Invades vascular endothelium and can translocate from the mouth to the gut, liver, and placenta." learnWhy="Dramatically enriched in colorectal cancer tissue. Also associated with adverse pregnancy outcomes and has been found in pancreatic cancer samples." learnCitation="Kostic et al., Genome Research, 2012. Fusobacterium in colorectal carcinoma, n=95." />
            </Section>
            ...
            <Section title="Breath & Metabolic" defaultOpen={false}>
              ...
              <SpeciesRow name="Fusobacterium spp." role="Aggregate Fusobacterium — cancer + inflammation" val={genus("Fusobacterium")} target="<1% reads" isPathogen={true} note="Total Fusobacterium genus; includes F. nucleatum, F. periodonticum, and other species" flagFn={v => flag(v < 1, v < 3)} learnWhat="The Fusobacterium genus contains multiple species with invasive and pro-inflammatory properties. They produce butyrate and other metabolites that can modulate host immunity." learnWhy="Elevated total Fusobacterium abundance is associated with periodontal disease, OSA, colorectal cancer risk, and adverse pregnancy outcomes." learnCitation="Kostic et al., Cell Host & Microbe, 2013. Fusobacterium and human disease." />
