  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "32px 24px 80px" }}>
      ...
      <div className="panel-grid-3" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 32 }}>
        <MetricCard label="Diversity score" value={shannon ?? "—"} status={shannonStatus} targetMin={4.0} targetMax={6.5} valueForIndicator={shannon ?? undefined} rangeMin={0} rangeMax={8} explanation="How many different bacteria live in your mouth and how evenly mixed they are. Higher oral diversity has been correlated with reduced all-cause mortality in population studies." source="Mondal et al. iScience. 2024; Vogtmann E et al. J Infect Dis. 2025." />
